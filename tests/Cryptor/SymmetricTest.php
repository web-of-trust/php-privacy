...
class SymmetricTest extends OpenPGPTestCase
{
    public function testCamelliaCipher()
    {
        ...
        $cipher->setPreferredEngine("PHP");
        $cipher->disablePadding();

        // 128 bit
        $cipher->setKey(hex2bin("00000000000000000000000000000000"));
        $encrypted = $cipher->encrypt(
            hex2bin("80000000000000000000000000000000")
        );
        $this->assertSame(
        ...
        $decrypted = $cipher->decrypt(
            hex2bin("07923a39eb0a817d1c4d87bdb82d1f1c")
        );
        $this->assertSame(
        ...
        $decrypted = $cipher->decrypt(
            hex2bin("6c227f749319a3aa7da235a9bba05a2c")
        );
        $this->assertSame(
        ...
        $decrypted = $cipher->decrypt(
            hex2bin("67673138549669730857065648eabe43")
        );
        $this->assertSame(
        ...
        // 192 bit
        $cipher->setKey(
            hex2bin("0123456789abcdeffedcba98765432100011223344556677")
        );
        $encrypted = $cipher->encrypt(
            hex2bin("0123456789abcdeffedcba9876543210")
        );
        ...
        $decrypted = $cipher->decrypt(
            hex2bin("b4993401b3e996f84ee5cee7d79b09b9")
        );
        $this->assertSame(
            "0123456789abcdeffedcba9876543210",
            bin2hex($decrypted)
        ...
        $cipher->setKey(
            hex2bin("000000000000000000000000000000000000000000000000")
        );
        $encrypted = $cipher->encrypt(
            hex2bin("00040000000000000000000000000000")
        );
        $this->assertSame(
        ...
        $decrypted = $cipher->decrypt(
            hex2bin("9bca6c88b928c1b0f57f99866583a9bc")
        );
        $this->assertSame(
        ...
        $cipher->setKey(
            hex2bin("949494949494949494949494949494949494949494949494")
        );
        $encrypted = $cipher->encrypt(
            hex2bin("636eb22d84b006381235641bcf0308d2")
        );
        $this->assertSame(
        ...
        $decrypted = $cipher->decrypt(
            hex2bin("94949494949494949494949494949494")
        );
        $this->assertSame(
        ...
        $decrypted = $cipher->decrypt(
            hex2bin("9acc237dff16d76c20ef7c919e3a7509")
        );
        $this->assertSame(
            "0123456789abcdeffedcba9876543210",
            bin2hex($decrypted)
        ...
        $encrypted = $cipher->encrypt(
            hex2bin("057764fe3a500edbd988c5c3b56cba9a")
        );
        $this->assertSame(
        ...
        $decrypted = $cipher->decrypt(
            hex2bin("4a4a4a4a4a4a4a4a4a4a4a4a4a4a4a4a")
        );
        $this->assertSame(
        ...
        $encrypted = $cipher->encrypt(
            hex2bin("7968b08aba92193f2295121ef8d75c8a")
        );
        $this->assertSame(
        ...
        $decrypted = $cipher->decrypt(
            hex2bin("03030303030303030303030303030303")
        );
        $this->assertSame(
    ...
    public function testIDEACipher()
    {
        ...
        $decrypted = $cipher->decrypt(
            hex2bin("ed732271a7b39f475b4b2b6719f194bf")
        );
        $this->assertSame(
        ...
        $decrypted = $cipher->decrypt(
            hex2bin("b8bc6ed5c899265d2bcfad1fc6d4287d")
        );
        $this->assertSame(
