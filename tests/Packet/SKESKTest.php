...
class SKESKTest extends OpenPGPTestCase
{
    ...
    {
        $skesk = SymmetricallyEncryptedSessionKey::encryptSessionKey(self::PASSPHRASE);
        $seipd = SymmetricallyEncryptedIntegrityProtectedData::encryptPacketsWithSessionKey(
            $skesk->getSessionKey(),
            new PacketList([LiteralData::fromText(self::LITERAL_TEXT)])
        );

        $this->assertSame(SymmetricallyEncryptedSessionKey::VERSION_4, $skesk->getVersion());
    ...
    public function testEncryptSessionKey()
    {
        ...
        $skesk = SymmetricallyEncryptedSessionKey::encryptSessionKey(self::PASSPHRASE, $sessionKey);
        $seipd = SymmetricallyEncryptedIntegrityProtectedData::encryptPacketsWithSessionKey(
            $skesk->getSessionKey(),
            new PacketList([LiteralData::fromText(self::LITERAL_TEXT)])
        );
        ...
        $this->assertTrue($skesk instanceof SymmetricallyEncryptedSessionKey);
        $this->assertTrue($seipd instanceof SymmetricallyEncryptedIntegrityProtectedData);
        $this->assertSame(SymmetricallyEncryptedSessionKey::VERSION_4, $skesk->getVersion());
        $this->assertSame(self::LITERAL_TEXT, trim($literalData->getData()));
    ...
    public function testAeadEaxDecryption()
    {
        ...
        $skesk = SymmetricallyEncryptedSessionKey::fromBytes(base64_decode($skeskData))->decrypt(self::PASSPHRASE);
    ...
    {
        $sessionKey = SessionKey::produceKey(Config::getPreferredSymmetric());
        $skesk = SymmetricallyEncryptedSessionKey::encryptSessionKey(
            self::PASSPHRASE,
            $sessionKey,
            Config::getPreferredSymmetric(),
            Config::getPreferredAead()
        );
        $this->assertSame(SymmetricallyEncryptedSessionKey::VERSION_6, $skesk->getVersion());
        $this->assertTrue(!empty($skesk->getEncrypted()));
        ...
        $this->assertSame(SymmetricallyEncryptedIntegrityProtectedData::VERSION_2, $seipd->getVersion());
        $this->assertTrue(!empty($seipd->getEncrypted()));
