...
class SKESKTest extends OpenPGPTestCase
{
    ...
    {
        $skesk = SymmetricKeyEncryptedSessionKey::encryptSessionKey(self::PASSPHRASE);
        ...
        $this->assertSame(SymmetricKeyEncryptedSessionKey::VERSION_4, $skesk->getVersion());
    ...
    public function testEncryptSessionKey()
    {
        ...
        $skesk = SymmetricKeyEncryptedSessionKey::encryptSessionKey(self::PASSPHRASE, $sessionKey);
        $seipd = SymEncryptedIntegrityProtectedData::encryptPacketsWithSessionKey(
            $skesk->getSessionKey(),
            new PacketList([LiteralData::fromText(self::LITERAL_TEXT)])
        );
        ...
        $this->assertTrue($skesk instanceof SymmetricKeyEncryptedSessionKey);
    ...
    public function testAeadEaxDecryption()
    {
        ...
        $skesk = SymmetricKeyEncryptedSessionKey::fromBytes(base64_decode($skeskData))->decrypt(self::PASSPHRASE);
    ...
    public function testAeadEncryptSessionKey()
    {
        ...
        $this->assertSame(SymmetricKeyEncryptedSessionKey::VERSION_6, $skesk->getVersion());
        $this->assertTrue(!empty($skesk->getEncrypted()));
