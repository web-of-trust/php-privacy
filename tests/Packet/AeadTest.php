...
/**
 * Testcase class for AEAD-encrypted data packet.
 */
class AeadTest extends OpenPGPTestCase
{
    ...
    public function testAeadEaxDecrypt()
    {
        ...
        $this->assertSame($aedp->getChunkSize(), 14);
        $this->assertSame($aedp->getIV(), $iv);
    ...
    public function testAeadOcbDecrypt()
    {
        ...
        $aedp = AeadEncryptedData::fromBytes($bytes);
        $this->assertEquals($aedp->getSymmetricAlgorithm(), SymmetricAlgorithm::Aes128);
        $this->assertEquals($aedp->getAeadAlgorithm(), AeadAlgorithm::Ocb);
        $this->assertSame($aedp->getChunkSize(), 14);
        $this->assertSame($aedp->getIV(), $iv);
    ...
    public function testAeadEncrypt()
    {
        ...
        $aedp = AeadEncryptedData::encryptPacketsWithSessionKey(
            $sessionKey,
